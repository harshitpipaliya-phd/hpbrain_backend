...
/**
 * CapabilityRepository — Brain-owned data.
 *
 ...
 */
final class CapabilityRepository extends BaseRepository
{
    protected function table(): string
    {
        return 'hpbrain_capabilities';
    }

    /** @return array<int, string> */
    protected function jsonColumns(): array
    {
        return ['knowledge', 'ability', 'skill', 'behaviour', 'attitude'];
    }
