...
final class PersonCompetencyRepository extends BaseRepository
{
    protected function table(): string
    {
        return 'hpbrain_person_competencies';
    }
    ...
    public function list(string $tenantId, ?string $personId = null, ?string $competencyId = null): array
    {
