...
{
    public function __construct(private readonly SkillRepository $repository)
    {
    }
    ...
    public function show(Request $request, string $tenantId, string $id): JsonResponse
    {
        ...
        return $row ? response()->json($row) : response()->json(['error' => 'skill_not_found'], 404);
    }
    ...
    {
        $data = $request->validate([
            'skill_key' => ['sometimes', 'string', 'max:100'],
    ...
    public function destroy(Request $request, string $tenantId, string $id): JsonResponse
    {
        ...
        return $ok ? response()->json(['ok' => true]) : response()->json(['error' => 'skill_not_found'], 404);
    }
}
