...
final class FiberValleyImportTest extends TestCase
{
    ...
    public function test_imported_data_produces_signals_with_linked_evidence(): void
    {
        ...
        $generator = new SignalGenerator(app(EventPublisher::class));
        $result = $generator->evaluate(self::TENANT);
    ...
    public function test_a_tenant_with_no_imported_data_gets_exactly_the_existing_erp_rules(): void
    {
        ...
        $generator = new SignalGenerator(app(EventPublisher::class));
        $result = $generator->evaluate(self::OTHER_TENANT);
        ...
        // Five ERP rules were evaluated; none of the operational rules ran.
        $this->assertSame(5, $result['created'] + $result['skipped']);
    ...
    public function test_profiles_are_published_into_the_existing_entity_mapping_table(): void
    {
        ...
        // One row per profile, refreshed rather than accumulated.
        $this->assertCount(1, $mappings);
        $this->assertSame('tickets', $mappings->first()->source_entity);
    }
    ...
    private function buildErpTables(): void
    {
        ...
        DB::table('institute_detail')->insert([
            ...
            'organization_code' => 'TESTCO', 'created_by' => 'phpunit',
        ]);
