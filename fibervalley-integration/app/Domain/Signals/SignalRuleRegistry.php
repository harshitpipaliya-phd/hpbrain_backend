 ...
 *   - FiberValley appears nowhere in this file, or in SignalGenerator.
 ...
 *
 * If the table does not exist yet — a deployment where the migration has not
 * run — this returns no rules rather than throwing. A missing optional table
...
final class SignalRuleRegistry
{
     ...
     */
    public function extraRulesFor(SignalGenerator $generator, string $tenantId): array
    {
        try {
